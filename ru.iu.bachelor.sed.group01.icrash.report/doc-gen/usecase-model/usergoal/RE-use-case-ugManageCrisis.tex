...
\addnumberedsinglerow{}{\msrucname{oeMakeFullReport [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeMakeFullReport} use case}
...
Figure \ref{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-ugManageCrisis}
...
\end{center}
\caption[ru.iu.bachelor.sed.group01.icrash Use Case Diagram: uc-ugManageCrisis]{ ugManageCrisis user goal use case}
\label{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-ugManageCrisis}
\end{figure}
\vspace{0.5cm}
