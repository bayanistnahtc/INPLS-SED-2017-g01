...
Figure \ref{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-ugSecurelyUseSystem}
...
\end{center}
\caption[ru.iu.bachelor.sed.group01.icrash Use Case Diagram: uc-ugSecurelyUseSystem]{ ugSecurelyUseSystem user goal use case}
\label{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-ugSecurelyUseSystem}
\end{figure}
\vspace{0.5cm}
