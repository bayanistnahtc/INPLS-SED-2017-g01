...
Figure \ref{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-suDeployAndRun}
...
\end{center}
\caption[ru.iu.bachelor.sed.group01.icrash Use Case Diagram: uc-suDeployAndRun]{ suDeployAndRun summary use case}
\label{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-suDeployAndRun}
\end{figure}
\vspace{0.5cm}
