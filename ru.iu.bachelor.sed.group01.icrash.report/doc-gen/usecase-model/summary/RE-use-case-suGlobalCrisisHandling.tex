...
Figure \ref{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-suGlobalCrisisHandling}
...
\end{center}
\caption[ru.iu.bachelor.sed.group01.icrash Use Case Diagram: uc-suGlobalCrisisHandling]{ suGlobalCrisisHandling user goal use case}
\label{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-suGlobalCrisisHandling}
\end{figure}
\vspace{0.5cm}
