...
Figure \ref{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-oeSetCrisisHandler}
...
\end{center}
\caption[ru.iu.bachelor.sed.group01.icrash Use Case Diagram: uc-oeSetCrisisHandler]{oeSetCrisisHandler subfunction use case
}
\label{fig:ru.iu.bachelor.sed.group01.icrash-RE-UCD-uc-oeSetCrisisHandler}
\end{figure}
\vspace{0.5cm}
