Figure \ref{fig:ru.iu.bachelor.sed.group01.icrash-CM-view-local-PrimaryTypes-Classes-04} shows the local view of the ctCrisis primary type class type.
...
\label{fig:ru.iu.bachelor.sed.group01.icrash-CM-view-local-PrimaryTypes-Classes-04}
\end{figure}
\vspace{0.5cm} 
