Figure \ref{fig:ru.iu.bachelor.sed.group01.icrash-CM-view-local-PrimaryTypes-Classes-02} shows the local view of the ctState primary type class type.
...
\label{fig:ru.iu.bachelor.sed.group01.icrash-CM-view-local-PrimaryTypes-Classes-02}
\end{figure}
\vspace{0.5cm} 
